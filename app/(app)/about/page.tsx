    ...
    <section className="flex w-full p-8">
      <div>
        ...
        <p>
          ...
          inteligencia artificial pudiera transformar la escritura científica en
          algo emocionante y creativo? Así comenzó la historia de esta
      ...
      <div>
        ...
        <p>
          Decidi convertir la frustracion de escribir en un viaje inspirador. No
          más bloqueos creativos ni documentos interminables. Solo tú, tus ideas
          y las tecnologías de inteligencia artificial, trabajando juntos para
          crear lo extraordinario.
        </p>
      </div>
    </section>
  );
